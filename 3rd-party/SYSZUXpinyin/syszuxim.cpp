...
SyszuxIM::SyszuxIM()
{
    ...
    //syszuxpinyin->setModal(false);
    //syszuxpinyin->resize(800,480);
    syszuxpinyin->move(115, 280);
}
...
void SyszuxIM::slotCommitString(QString text)
{
    sendCommitString(text);
    QApplication::focusWidget()->clearFocus();
}

void SyszuxIM::slotPreeditString(QString text)
{
...
void SyszuxIM::updateHandler(int type)
{
    ...
    case QWSInputMethod::FocusIn:
        syszuxpinyin->setLineEditText(QString(""));
        syszuxpinyin->show();
        break;
