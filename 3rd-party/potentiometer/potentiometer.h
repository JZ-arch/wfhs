...
/**
  PotentioMeter is input widget designed to be used with touchscreens.
  It delivers 4 predefined themes
  ...
  Feel free to add your own themes.
  To do that please follow id names in the svg files.
*/ 
...
public slots:
    /** 
        Sets ticks to rotation
        If rotationRange is equal to maximum()-minimum(), widget is wrapped.
        That allows to rotate dial many times.
     */
